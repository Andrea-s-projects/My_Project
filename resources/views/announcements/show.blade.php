                ...
                <div class="card shadow rounded-4">
                    <div id="showCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                <img src="{{ $image->getUrl(400, 300) }}" class="d-block w-100 rounded-4 "
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('categoryShow', ['category' => $announcement->category]) }}"
                            class="btn bg-light shadow mb-3">{{ __('ui.Category') }} {{ $announcement->category->name
                            }}</a>

                        <p class="mb-0 text-muted">{{ __('ui.Published') }} {{
                    ...
                    <div class="card-footer text-center border-2 text-muted">
                        <form action="{{ route('comments.store') }}" method="POST">
                            ...
                            <textarea name="comment" maxlength="120" rows="3" class="form-control my-"
                                placeholder="{{ __('ui.Entercomment') }}"></textarea>
                            <button type="submit" class="btn-cta rounded-5  shadow my-2">{{ __('ui.AddComment')
                                }}</button>
                        </form>
                    </div>
                </div>
